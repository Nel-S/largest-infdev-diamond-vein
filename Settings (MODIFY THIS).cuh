...
#define INPUT_DATA TEST_DATA_BETA_1_6__1
#define INPUT_DATA_LAYOUT TEST_DATA_BETA_1_6__1_LAYOUT
...
// __device__ constexpr Pair<InclusiveRange<float>> ANGLE_BOUNDS = {{0.f, 0.2905f}, {0.7095f, 1.f}};
// __device__ constexpr Pair<InclusiveRange<float>> ANGLE_BOUNDS = {{0.115f, 0.296f}, {0.704f, 0.885f}};
